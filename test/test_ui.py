...
def test_search_by_author ():
        ...
        with allure.step ("Найти книгу по автору Михаил Булгаков"):
            author_name = "Михаил Булгаков"
            search_by_author(author_name)
        
        with allure.step ("Получить результаты поиска"):
            results_find = driver.find_element(By.CSS_SELECTOR, ".product-card__subtitle")
...
def test_add_to_card():
        ...
        with allure.step ("Добавить в корзину книгу с названием Мастер и Маргарита"):
            book_title = "Мастер и Маргарита"
            add_to_card(book_title)
        
        with allure.step ("Получить результаты добавления в корзину"):
            results_add = driver.find_element(By.CSS_SELECTOR, ".product-card__title")
...
def test_mixed_request():
        ...
        with allure.step ("Найти книгу по смешанному запросу"):
            book_title = "МасtEr and Маргарита"
